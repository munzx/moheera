...
module.exports = function (app, express) {
	...
	v1.use('/v1', express.Router()
		...
		.get('/admin/category', isAdmin, admin.category)
		.post('/admin/category', isAdmin, admin.addCategory)
		.put('/admin/category/:id', isAdmin, admin.updateCategory)
		.delete('/admin/category/:id', isAdmin, admin.removeCategory)
